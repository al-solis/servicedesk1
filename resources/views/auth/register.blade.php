<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- ID -->
        <div class = "grid mt-1 sm:grid-cols-2 gap-2">
            <div class = "sm:col-span-1">
                <x-input-label for="empid" :value="__('Client ID')" />
                <x-text-input id="empid" class="block mt-1 w-full" type="number" name="empid" :value="old('empid')"
                    required autofocus autocomplete="employee id" />
        ...
        {{-- <div class = "grid mt-1 sm:grid-cols-3 gap-2">
            <!-- Last Name -->
            <div>
