        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="w-full md:w-1/2">
                    <form action="{{ route('kb.index')}}" method="GET" class="flex items-center">
                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <a href="{{ route('kb.create') }}" class="flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3 w-[800px]">Title</th>
                            <th scope="col" class="px-4 py-3 w-[200px]">Category</th>
                            <th scope="col" class="px-4 py-3 w-[150px]">Status</th>
                    ...
                    <tbody class="min-h-[200px]">
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <td class="px-4 py-3 w-[100px]">{{ $article->id }}</td>                        
                            <td class="px-4 py-3 w-[800px]">{{ $article->title }}</td>                        
                            <td class="px-4 py-3 w-[200px]">{{ $article->category->description }}</td>
                            <td class="px-4 py-3 w-[150px]">
                                <span class="inline-flex justify-center items-center w-[70px] h-[14px] px-4 py-2 rounded-md font-semibold text-xs" 
                                    ...
                                    @if($article->status == 'Active') #d4edda; color: #155724;                                
                                    @elseif($article->status == 'Inactive') #f8d7da; color: #721c24;
                                    @endif">
                                    {{ $article->status }}
                                </span>
                            </td>
                            <td class="px-4 py-3">
                                <div class="relative inline-block">
                                    <button id="dropdown-btn-{{ $article->id }}" data-dropdown-toggle="dropdown-menu-{{ $article->id }}" 
                                    ...
                                    <div id="dropdown-menu-{{ $article->id }}" 
                                        ...
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                                            {{-- <li>
                                                <a href="{{ route('kb.show', $article->id) }}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Show</a>
                                            </li> --}}
                                            <li>
                                                <a href="{{ route('kb.edit', $article->id) }}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                                            </li>
                                        </ul>                                    
                                    </div>
                                </div>                                
