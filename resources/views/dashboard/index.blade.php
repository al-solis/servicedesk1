...
<meta description="Incident & Support Management System Dashboard">
{{-- @import('flowbite'); --}}
...
@section('navbar-content')
    ...
    @if (auth()->check())
                ...
                <div class="grid gap-4 xl:grid-cols-2 2xl:grid-cols-3">
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div data-popover id="chart-info" role="tooltip"
                                ...
                                <div class="p-3 space-y-2">
                                    ...
                                    <p>This graph shows the total count for Open, In Progress, On-hold, Closed and Cancelled
                                        tickets</p>
                            ...
                            <div class="grid grid-cols-5 gap-3 mb-2">
                                <dl
                                    ...
                                    <dt id="open-tickets"
                                        ...
                                        data-count="{{ $tickets->where('status', 'Open')->count() }}">
                                        {{ $tickets->where('status', 'Open')->count() }}</dt>
                                ...
                                <dl
                                    ...
                                    <dt id="inprogress-tickets"
                                        ...
                                        data-count="{{ $tickets->where('status', 'In Progress')->count() }}">
                                        {{ $tickets->where('status', 'In Progress')->count() }}</dt>
                                    <dd class="text-orange-600 dark:text-orange-300 text-sm font-medium">In Progress</dd>
                                </dl>
                                <dl
                                    class="bg-purple-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                                    <dt id="onhold-tickets"
                                        ...
                                        data-count="{{ $tickets->where('status', 'On-hold')->count() }}">
                                        {{ $tickets->where('status', 'On-hold')->count() }}</dt>
                                ...
                                <dl
                                    ...
                                    <dt id="closed-tickets"
                                        ...
                                        data-count="{{ $tickets->where('status', 'Closed')->count() }}">
                                        {{ $tickets->where('status', 'Closed')->count() }}</dt>
                                    <dd class="text-teal-600 dark:text-teal-300 text-sm font-medium">Closed</dd>
                                </dl>
                                <dl
                                    class="bg-red-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                                    <dt id="cancelled-tickets"
                                        ...
                                        data-count="{{ $tickets->where('status', 'Cancelled')->count() }}">
                                        {{ $tickets->where('status', 'Cancelled')->count() }}</dt>
                        ...
                        <div
                            ...
                            <div>
                                <button id="dropdownButton"
                                    ...
                                    data-dropdown-trigger="click">Last 7 days
                    ...
                    @if (Auth::user()->usertype != 'User')
                        <div
                            ...
                            <h3 class="flex items-center mb-4 text-lg font-semibold text-gray-900 dark:text-white">User
                                statistics
                            ...
                            <ul class="hidden text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg sm:flex dark:divide-gray-600 dark:text-gray-400"
                                ...
                                <li class="w-full">
                                    <button id="sessions-tab" data-tabs-target="#sessions" type="button" role="tab"
                                        aria-controls="sessions" aria-selected="true"
                                        class="inline-block w-full p-4 rounded-tl-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">Current
                                        Sessions</button>
                                </li>
                                <li class="w-full">
                                    <button id="about-tab" data-tabs-target="#about" type="button" role="tab"
                                        aria-controls="about" aria-selected="false"
                                        class="inline-block w-full p-4 rounded-tr-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">Recently
                                        Added</button>
                                </li>
                            </ul>
                                          ...
                                          user-color"
                                                        ...
                                                        @else
                                                            ...
                                                            <img class="w-8 h-8 rounded-full"
                                                                src="{{ asset('storage/' . $login->profile_picture) }}"
                                                                alt="{{ $login->lname }}">
                                                        @endif
                                                        <div class="ml-3">
                                                            <p
                                                                class="font-medium text-sm text-gray-900 truncate dark:text-white">
                                                                {{ $login->lname }} {{ $login->fname }}
                                                                {{ substr($login->mname, 0, 1) }}.
                                                            </p>
                                ...
                                <div class="hidden pt-4" id="about" role="tabpanel" aria-labelledby="about-tab">
                                    ...
                                    user-color"
                                                        ...
                                                        @else
                                                            ...
                                                            <img class="w-8 h-8 rounded-full"
                                                                src="{{ asset('storage/' . $lastCreatedUsers->profile_picture) }}"
                                                                alt="{{ $lastCreatedUsers->lname }}">
                                                        @endif
                                                        <div class="ml-3">
                                                            <p
                                                                class="font-medium text-sm text-gray-900 truncate dark:text-white">
                                                                {{ $lastCreatedUsers->lname }}
                                                                {{ $lastCreatedUsers->fname }}
                                                                {{ substr($lastCreatedUsers->mname, 0, 1) }}.
                                                            </p>
                                                            <p class="text-sm text-gray-500 truncate dark:text-gray-400">
        ...
        {{-- <script>
            ...
            let currentRange = 'last7days'; // default
            ...
            document.querySelectorAll('#weekly-sales-dropdown a').forEach(item => {
                item.addEventListener('click', function(event) {
                    ...
                    currentRange = rangeMap[label] || 'last7days';
        ...
        <script>
                    ...
                    tooltip: {
                        ...
                        y: {
                            formatter: function(value, {
                                ...
                                const percentageValue = series[seriesIndex];
                                const ticketCount = counts[seriesIndex];
                                return `${percentageValue.toFixed(1)}% (${ticketCount} tickets)`;
                            },
                            title: {
                        ...
                        custom: function({
                            ...
                            return `<div class="apexcharts-tooltip-custom" style="padding: 8px 12px; background: #1F2937; color: white; border-radius: 6px; font-size: 12px;">
                        <strong>${label}</strong><br/>
                        ${percentage.toFixed(1)}% (${ticketCount} tickets)<br/>
                        <span style="font-size: 10px; opacity: 0.8;">of ${TotalTickets} total tickets</span>
                    </div>`;
                        }
                    },
                    yaxis: {
            ...
            function updateTickets(range) {
                fetch(`{{ route('dashboard.ticket-counts') }}?range=${range}`)
                    .then(response => response.json())
                    .then(data => {
                        updateTicketCount('open-tickets', data.open);
                        updateTicketCount('inprogress-tickets', data.inprogress);
            ...
            function updateTicketCount(elementId, count) {
                ...
                if (element) {
                    ...
                    element.setAttribute('data-count', count ?? 0);
                }
            }
        </script>
