        ...
        <form action="#">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-4 ml-2 mt-2">
                    ...
                    <div class="flex flex-wrap gap-4 justify-between">
                        <div class="flex-1 min-w-[90px] md:min-w-[100px]">
                            <!-- Team Selection -->
                            <label for="team" class="block text-sm font-medium text-gray-900 dark:text-gray-300">Support
                                Team</label>
                ...
                <div>
                    <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Support
                        History</label>
            ...
            <div class="flex justify-end mr-2">
                <a href="{{ route('tickets.index') }}"
                    class="mb-4 mt-4 mr-2 text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Close
                </a>
            </div>
        </form>
