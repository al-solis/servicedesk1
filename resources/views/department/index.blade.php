        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="w-full md:w-1/2">
                    <form action="{{ route('department.index')}}" method="GET" class="flex items-center">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody class="min-h-[200px]">
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <td class="px-4 py-3 w-[100px]">{{ $dept->id }}</td>                        
                            <td class="px-4 py-3 w-[300px]">{{ $dept->description }}</td>                            
                            <td class="px-4 py-3 w-[120px] text-center">
                                <div class="relative inline-block">
                                    <button id="dropdown-btn-{{ $dept->id }}" data-dropdown-toggle="dropdown-menu-{{ $dept->id }}" 
                                    ...
                                    <div id="dropdown-menu-{{ $dept->id }}" 
                                        ...
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                                            <li>
                                                <a href="{{ route('department.show', $dept->id) }}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Show</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('department.edit', $dept->id) }}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                                            </li>
                                        </ul>                                    
                                    </div>
                                </div>                    
