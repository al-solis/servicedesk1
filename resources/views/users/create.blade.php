                    ...
                    <form action="{{ route('users.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="empid" class="block text-sm font-medium text-gray-700">Employee/ Client
                                    ID</label>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="telno" name='telno'
                                        ...
                                        pattern="[0-9]{4}-[0-9]{3}-[0-9]{4}" placeholder="0910-123-4567" />
                                </div>
                                <p id="helper-text-explanation" class="mt-2 text-sm text-gray-500 dark:text-gray-400">Input
                                    a phone number that matches the format.</p>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select id="usertype" name="usertype"
                                    ...
                                    <option value="Support Team" {{ $users->usertype == 'Support Team' ? 'selected' : '' }}>
                                        Support Team</option>
                                    <option value="User" {{ $users->usertype == 'User' ? 'selected' : '' }}>User</option>
                                    <option value="Client" {{ $users->usertype == 'Client' ? 'selected' : '' }}>Client
                                    </option>
                                </select>
                            ...
                            @if ($errors->any())
                                <div id="toast-danger"
                                    class="fixed top-5 left-1/2 transform -translate-x-1/2 z-50 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800"
                                    role="alert">
                                    <div
