            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-12 lg:grid-cols-12">
                    <div class="mr-auto place-self-center lg:col-span-7">
                        ...
                        <p
                            ...
                            <br> <br>
                            It allows personnel, security guards, administrative staff, and even external clients to
                            easily submit tickets, monitor their status in real time, and communicate directly with the
                            responsible teams. This streamlined process promotes faster resolution, better coordination,
                            and greater accountability across the organization.
                        </p>
                ...
                <footer class="py-8 text-center text-xs text-gray-500 dark:text-white/70">
                    ...
                    <div class="copyright text-center my-auto">
                        <span>KESIA Incident and Support Management System &copy; {{ date('Y') }}</span>
                    </div>
                </footer>
            </div>
        </div>
