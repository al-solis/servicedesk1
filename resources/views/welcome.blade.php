                ...
                <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div class="mr-auto place-self-center lg:col-span-7">
                        ...
                        <p
                            ...
                            company-wide
                            platform designed to streamline the handling of service requests, concerns, and incident
                            reports across all departments, including Security Operations, Human Resources, Payroll,
                            Accounting, and IT. The system enables personnel, guards, and administrative staff to submit
                            tickets, track progress in real time, and communicate efficiently with assigned departments,
