      ...
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <a href="#" class="flex items-center justify-between mr-4">
            <img
              ...
              alt="Logo"
            />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Online IT Service Desk</span>
          </a>
        </div>
        <div class="flex items-center lg:order-2">
                  ...
                  <div class="pl-3 w-full">
                        ...
                        >
                          ...
                          <span class="font-semibold text-gray-900 dark:text-white"
                            >{{$ticket->user->fname}} {{$ticket->user->lname}}</span
                          >: {{$ticket->description}}
                        </div>
                        <div
          ...
          >
            <div class="py-3 px-4">
              <span
                class="block text-sm font-semibold text-gray-900 dark:text-white">{{ Auth::user()->lname }}, {{ Auth::user()->fname }} {{ substr(Auth::user()->mname,0,1) }}.</span>
              <span
          ...
          <li>
              ...
              @if (Auth::user()->usertype == 'Administrator')
                  ...
                  <a
                    ...
                    <button
                      ...
                      data-collapse-toggle="dropdown-maintenance">
                      <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <button
                type="button"
                class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                aria-controls="dropdown-KB"
                data-collapse-toggle="dropdown-KB">
              <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
              ...
              <ul id="dropdown-KB" class="hidden py-2 space-y-2">
                ...
                <li>
                  <a
                    href="{{ route('articles.article-index')}}"
                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    >Article</a>
                </li>
                <li>
        ...
        <ul
          ...
          <li>
            ...
            <ul id="dropdown-Reports" class="hidden py-2 space-y-2">              
                <li>
                  <a
                    href="{{ route('reports.index-detail')}}"
                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    >Ticket - Detailed</a>
                </li>              
              <li>
                <a
                  href="{{ route('reports.index-summary')}}"
                  class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                  >Ticket - Summary</a>
              </li>
              @if (Auth::user()->usertype != 'User')
