            ...
            <form action="{{ route('tickets.update', $ticket->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2 ml-2">
                        ...
                        @if ($ticket->user_id != Auth::user()->id or !in_array(Auth::user()->usertype, ['User', 'Client']))
                            <div class="sm:col-span-2">
                ...
                <div class="flex justify-end space-x-4 mr-2">
                    <a href="{{ route('tickets.index') }}"
                        class="mb-4 mt-4 text-gray-700 inline-flex items-center bg-gray-200 hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                        Cancel
                    </a>
                    <button type="submit"
                        class="mb-4 mt-4 text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Update Ticket
                    </button>
                </div>
            </form>
