            ...
            <div id="createModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative p-4 w-full max-w-xl h-full md:h-auto">
                    ...
                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        <!-- Modal header -->
                        <div
                            class="flex justify-between items-center pb-2 mb-2 rounded-t border-b sm:mb-2 dark:border-gray-600">
                            ...
                            <div class="grid gap-2 mb-4 sm:grid-cols-2">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea id="description" name="description" rows="3"
                                        ...
                                        placeholder="Please provide more details about the issue..." required></textarea>
                                </div>
                                ...
                                {{-- <div class="flex flex-wrap gap-4 justify-between">
                                    ...
                                    <div class="flex-1 min-w-[90px] md:min-w-[100px]">
                                        <label
                                            class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Priority</label>
