        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <a href="{{ route('users.create')}}" class="flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
            ...
            <div class="overflow-x-auto" style="min-height: 500px;">
                ...
                <tbody class="min-h-[200px]">
                    ...
                    <tr class="border-b dark:border-gray-700">
                        ...
                        <td class="px-4 py-3 w-[300px]">{{ $userm->dept_id ? $userm->department->description : '' }}</td>          
                        <td class="px-4 py-3 w-[100px] text-center">
                            {{-- <span class="inline-flex justify-center items-center w-[70px] h-[14px] px-4 py-2 rounded-md font-semibold text-xs" 
                                ...
                                @if($userm->status == 'Active') #d4edda; color: #155724;
                                @elseif($userm->status == 'Inactive') #f8d7da; color: #721c24;
                                @endif">
                                {{ $userm->status }}
                            </span> --}}                            

                              <label class="inline-flex items-center cursor-pointer">
                                <input type="checkbox" class="sr-only peer toggle-status" data-id="{{ $userm->id }}" {{ $userm->status == 'Active' ? 'checked' : '' }}>
                                <div class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600 dark:peer-checked:bg-blue-600"></div>
                                {{-- <span class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300 status-text">
                                    {{ $userm->status }}
                                </span> --}}
                            </label>
                        </td>
                        <td class="px-4 py-3 w-[120px] text-center">
                            <div class="relative inline-block">
                                <button id="dropdown-btn-{{ $userm->id }}" data-dropdown-toggle="dropdown-menu-{{ $userm->id }}" 
