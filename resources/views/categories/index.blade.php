                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3 w-[300px]">Description</th>
                                    <th scope="col" class="px-4 py-3 w-[150px]">Type</th>
                                    <th scope="col" class="px-4 py-3 w-[200px]">Default</th>
                                    ...
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3 w-[120px] text-center">
                                            <div class="relative inline-block">
                                                <button id="dropdown-btn-{{ $category->id }}"
                                                    data-dropdown-toggle="dropdown-menu-{{ $category->id }}"
                                                ...
                                                <!-- Dropdown Menu -->
                                                <div id="dropdown-menu-{{ $category->id }}"
                            ...
                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea id="description" name="description" rows="4"
                                        ...
                                        placeholder="Enter category name here" required></textarea>
                                </div>

                                <div class="sm:col-span-2">
                                    <label for="type_id"
                                        class="block text-sm font-medium text-gray-900 dark:text-gray-300">Category
                                        Type</label>
                                    <select id="type_id" name="type_id"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        required>
                                        <option value="">Select category type</option>
                                        <option value="0">Internal Client</option>
                                        <option value="1">External Client</option>
                                    </select>
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    <!-- Team Selection -->
                                    <label for="team_id"
                                        class="block text-sm font-medium text-gray-900 dark:text-gray-300">Default Support
                                        Team</label>
