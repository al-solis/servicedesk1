                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody class="min-h-[200px]">
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 w-[200px]"> {{ $category->default_group ? $category->default_group->name : '' }}</td>
                            <td class="px-4 py-3 w-[120px] text-center">
                                <div class="relative inline-block">
                                    <button id="dropdown-btn-{{ $category->id }}" data-dropdown-toggle="dropdown-menu-{{ $category->id }}" 
                                    ...
                                    <div id="dropdown-menu-{{ $category->id }}" 
                                        ...
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                                            <li>
                                                <a href="{{ route('categories.show', $category->id) }}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Show</a>
                                            </li>
                                            <li>
                ...
                <form action="{{ route('categories.store') }}" method="POST">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">                        
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="description" name="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter category name here" required></textarea>
                        </div>
                        
                        <div class="sm:col-span-2">
                            <!-- Team Selection -->
                            <label for="team" class="block text-sm font-medium text-gray-900 dark:text-gray-300">Default Support Team</label>
